...
/**
 * Portal shell - sidebar for the client-facing portal (/portal/*).
 * Four destinations: Dashboard, Reports, Targets, Settings.
 */
...
export function PortalSidebar({
  ...
  const badge = businessName ? (
    <span className="inline-block rounded-full bg-accent-soft px-2.5 py-0.5 text-xs font-bold uppercase tracking-wide text-accent-deep">
      {businessName}
    </span>
  ) : null;
  return (
